...
public class CloudinaryConfig {
    ...
    public String creatUrl (String name){
        ...
        return cloudinary.url().transformation(new Transformation().width(100).height(100)
                .crop("fill").radius(50).gravity("face")).generate(name);
    }


    public String creatUrl(String name, int width, int height){
